...
public:
	StudentData* printInfo(StudentData* s)
	{
		...
		while (s[i].name != "")
		{
			...
			cout << "\n|ÍÎÌÅĞ ÇÀ×ÅÒÍÎÉ ÊÍÈÆÊÈ:	    |" << s[i].booknum;
			cout << "\n|___________________________|______________________________|";
			cout << "\n|ÄÀÒÀ ĞÎÆÄÅÍÈß:		    |" << s[i].birthDay << "." << s[i].birthMonth << "." << s[i].birthYear;
			cout << "\n|___________________________|______________________________|";
			cout << "\n|ÏÎË:		            |" << s[i].sex;
			cout << "\n|___________________________|______________________________|";
			cout << "\n|ÈÍÑÒÈÒÓÒ:		    |" << s[i].inst;
			cout << "\n|___________________________|______________________________|";
			cout << "\n|ÍÀÏĞÀÂËÅÍÈÅ:		    |" << s[i].faculty;
			cout << "\n|___________________________|______________________________|";
			cout << "\n|ÃÎÄ ÏÎÑÒÓÏËÅÍÈß:	    |" << s[i].startYear;
			cout << "\n|___________________________|______________________________|";
			for (int k2 = 0; k2 < sesscount; k2++)
			{
				cout << "\nÎöåíêè çà " << k2 + 1 << " ñåññèş: ";
	...
	void addStudent()
	{
		...
		cout << "===================================" << endl;
		cout << "|  ÌÅÍŞ ÂÂÎÄÀ ÄÀÍÍÛÕ ÎÁ Ó×ÅÍÈÊÀÕ  |" << endl;
		cout << "===================================" << endl;
		...
		for (int i = 0; i < n; i++)
		{
			...
			while (students[i].sex != "Ì" && students[i].sex != "Æ")
			{
				...
				cin.clear();
				cin.ignore(100, '\n');
				cout << "Íåêîğğåêòíûé ââîä!\nÏîïğîáóéòå åù¸ ğàç (ââåäèòå òîëüêî 1 áóêâó):";
			}
			...
			{
				cout << "\nÂâåñòè êîë-âî ïğåäìåòîâ çà " << k + 1 << " ñåññèş: ";
				cin >> NumMarks;
				if (NumMarks > 10)
				{
					NumMarks = 10;
				...
				{
					cout << "\nÂâåäèòå íàçâàíèå ïğåäìåòà " << k1 + 1 << " : ";
					students[i].sess[k].subj[k1] = istring();
					cout << "\nÂâåäèòå îöåíêó çà ïğåäìåò " << students[i].sess[k].subj[k1] << " : ";
		...
		delete[] students;
		cout << "Ãîòîâî. Íàæìèòå ENTER, ÷òîáû âåğíóòüñÿ â ãëàâíîå ìåíş";
		getchar();
		getchar();
		int main();
	}
	...
	void edit_student()
	{
		...
		cout << "|------------------------------------|" << endl;
		cout << "|  ÌÅÍŞ ÈÇÌÅÍÅÍÈß ÄÀÍÍÛÕ Î ÑÒÓÄÅÍÒÀÕ |" << endl;
		cout << "|------------------------------------|" << endl;
		cout << "Ââåäèòå Ôàìèëèş ñòóäåíòà: " << endl;
		surname = istring();
		...
		if (student[0].name != "" && student[0].name == name && student[0].surname == surname)
		{
			...
			while (getline(ifs, line))
			{
				if (line.find(subs) != string::npos)
				{
					...
					cout << "\n|(2) ÈÇÌÅÍÈÒÜ ÈÌß			|";
					cout << "\n|(3) ÈÇÌÅÍÈÒÜ ÎÒ×ÅÑÒÂÎ			|";
					cout << "\n|(4) ÈÇÌÅÍÈÒÜ ÄÀÒÓ ĞÎÆÄÅÍÈß		|";
					cout << "\n|(5) ÈÇÌÅÍÈÒÜ ÃÎÄ ÏÎÑÒÓÏËÅÍÈß		|";
					cout << "\n|(6) ÈÇÌÅÍÈÒÜ ÊÀÔÅÄĞÓ			|";
					cout << "\n|(7) ÈÇÌÅÍÈÒÜ ÈÍÑÒÈÒÓÒ			|";
					cout << "\n|(8) ÈÇÌÅÍÈÒÜ ÃĞÓÏÏÓ			|";
					cout << "\n|(9) ÈÇÌÅÍÈÒÜ ÍÎÌÅĞ ÇÀ×.ÊÍÈÆÊÈ		|";
					cout << "\n|(10) ÈÇÌÅÍÈÒÜ ÏÎË			|";
					cout << "\n|(11) ÈÇÌÅÍÈÒÜ ÎÖÅÍÊÓ Â ÑÅÑÑÈÈ		|";
					cout << "\n|_______________________________________|";
					cout << "\nÂÂÅÄÈÒÅ ÍÎÌÅĞ ÄÅÉÑÒÂÈß:  ";
					cin >> n;
					switch (n)
					{
					case 1:
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÓŞ ÔÀÌÈËÈŞ: ";
					...
					case 3:
						...
						break;
					case 4:
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÓŞ ÄÀÒÓ ĞÎÆÄÅÍÈß: ";
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÛÉ ÃÎÄ ĞÎÆÄÅÍÈß: ";
						student[0].birthYear = iyear();
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÛÉ ÌÅÑßÖ ĞÎÆÄÅÍÈß: ";
						student[0].birthMonth = imonth();
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÛÉ ÄÅÍÜ ĞÎÆÄÅÍÈß: ";
					...
					case 7:
						...
						break;
					case 8:
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÓŞ ÃĞÓÏÏÓ: ";
						student[0].group = istring();
						break;
					case 9:
						cout << "\nÂÂÅÄÈÒÅ ÍÎÂÓŞ ÍÎÌÅĞ ÇÀ×ÅÒÍÎÉ ÊÍÈÆÊÈ: ";
					...
					case 11:
						cout << "\nÂÂÅÄÈÒÅ ÍÎÌÅĞ ÑÅÑÑÈÈ: ";
						sessnum = iint();
						cout << "\nÂÂÅÄÈÒÅ ÍÀÇÂÀÍÈÅ ÏĞÅÄÌÅÒÀ";
						subj = istring();
						for (int i = 0; i < 10; i++)
						{
							if (student[0].sess[sessnum].subj[i] == subj)
							{
								cout << "\nÏĞÅÄÌÅÒ" << student[0].sess[sessnum].subj[i] << "ÍÀÉÄÅÍ!\n";
								cout << "ÎÖÅÍÊÀ" << student[0].sess[sessnum].mark[i];
								cout << "\nÂÂÅÄÈÒÅ ÍÎÂÓŞ ÎÖÅÍÊÓ: ";
	...
	void delete_student()
	{
		...
		string man = "Ì", woman = "Æ";
		cout << "|------------------------------------|" << endl;
		cout << "|  ÌÅÍŞ ÓÄÀËÅÍÈß ÄÀÍÍÛÕ Î ÑÒÓÄÅÍÒÅ   |" << endl;
		cout << "|------------------------------------|" << endl;
		cout << "Ââåäèòå Ôàìèëèş ñòóäåíòà: " << endl;
		surname = istring();
		cout << "Ââåäèòå Èìÿ ñòóäåíòà: " << endl;
	...
	void import_students() { //ïğåäïîëàãàåòñÿ, ÷òî â ğåïîçèòîğèè áóäåò íàõîäèòüñÿ ñòîğîííÿÿ áàçà ñòóäåíòîâ, 
		//ìû äîëæíû áóäåì ââåñòè íàçâàíèå ôàéëà ÷òîáû èìïîğòèğîâàòü çàïèñè â îñíîâíîé ôàéë
		string filename, line;
		int n = 0;
		cout << " _______________________________________" << endl;
		cout << "|  ÌÅÍŞ ÈÌÏÎĞÒÀ ÄÀÍÍÛÕ ÈÇ ÄĞÓÃÎÃÎ ÔÀÉËÀ |" << endl;
		cout << "|_______________________________________|" << endl;
		cout << "| ÊÀÊÎÃÎ ÔÎĞÌÀÒÀ ÔÀÉË?                  |" << endl;
		cout << "| (1) ÁÈÍÀĞÍÛÉ                          |" << endl;
		cout << "| (2) ÎÁÛ×ÍÛÉ ÒÅÊÑÒÎÂÛÉ                 |" << endl;
		cout << "|_______________________________________|" << endl;
		cout << "ÂÛÁÅĞÈÒÅ ÔÎĞÌÀÒ: ";
		n = iint();
		...
		cout << "\nÄÀÍÍÛÅ ÁÛËÈ ÓÑÏÅØÍÎ ÏÅĞÅÍÅÑÅÍÛ!!!!\n";
		cout << "Ãîòîâî. Íàæìèòå ENTER, ÷òîáû âåğíóòüñÿ â ãëàâíîå ìåíş";
		getchar();
		getchar();
		int main();
	...
	void show_student()
	{
		...
		string name, surname;
		cout << "|----------------------------------------------|" << endl;
		cout << "|      Âûâîä èíôîğìàöèè î ñòóäåíòå íà ıêğàí    |" << endl;
		cout << "|______________________________________________|" << endl;
		cout << "Ââåäèòå Ôàìèëèş ñòóäåíòà: " << endl;
		surname = istring();
		cout << "Ââåäèòå Èìÿ ñòóäåíòà: " << endl;
		...
		{
			cout << "Òàêîãî ñòóäåíòà íåò. íàæìèòå åíòåğ, ÷òîáû ïîâòîğèòü ïîïûòêó";
			getchar();
			getchar();
			show_student();
		}
