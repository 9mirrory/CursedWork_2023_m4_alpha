...
public:
	...
	void edit_student()
	{
		...
		cout << "|------------------------------------|" << endl;
		cout << "|  ÌÅÍÞ ÈÇÌÅÍÅÍÈß ÄÀÍÍÛÕ Î ÑÒÓÄÅÍÒÅ  |" << endl;
		cout << "|------------------------------------|" << endl;
		cout << "| (1) ÏÎ ÍÎÌÅÐÓ ÇÀ×ÅÒÍÎÉ ÊÍÈÆÊÈ      |" << endl;
		cout << "| (2) ÏÎ ÈÌÅÍÈ È ÔÀÌÈËÈÈ             |" << endl;
		...
		{
			cout << "\nÒàêîãî ñòóäåíòà íåò. íàæìèòå åíòåð, ÷òîáû ïîâòîðèòü ïîïûòêó";
			getchar();
			getchar();
			edit_student();
		}
	...
	void import_students() { //ïðåäïîëàãàåòñÿ, ÷òî â ðåïîçèòîðèè áóäåò íàõîäèòüñÿ ñòîðîííÿÿ áàçà ñòóäåíòîâ, 
		...
		{
			cout << "\nÎØÈÁÊÀ. ÔÀÉË ÎÊÀÇÀËÑß ÏÓÑÒÎÉ ÈËÈ ÍÅ ÑÓÙÅÑÒÂÓÅÒ Â ÐÅÏÎÇÈÒÎÐÈÈ.\n";
			getchar();
			getchar();
	...
	void exercise()
	{
		...
		{
			cout << "Òàêîé ãðóïïû íåò. íàæìèòå åíòåð, ÷òîáû ïîâòîðèòü ïîïûòêó";
			getchar();
			getchar();
			show_student();
		}
